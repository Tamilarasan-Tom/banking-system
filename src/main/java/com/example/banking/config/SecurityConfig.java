    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // Allow static files and authentication API
                .requestMatchers("/", "/index.html", "/login.html", "/register.html", "/admin-login.html", "/dashboard.html", "/admin-dashboard.html").permitAll()
